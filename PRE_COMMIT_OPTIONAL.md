# Pre-commit (опциональная функция)

## 📌 Важно знать

**Pre-commit НЕ обязателен** для работы расширения!
...
## ✅ Основные функции работают без pre-commit:

- ✅ yamllint - проверка синтаксиса YAML
- ✅ ansible-lint - проверка Ansible best practices
- ✅ Встроенный fixer - исправление отступов
- ✅ Визуализация родительских ключей
- ✅ Диагностика ошибок

## 🔧 Когда нужен pre-commit?

Pre-commit нужен только если вы:
- Используете `.pre-commit-config.yaml` в проекте
- Хотите запускать pre-commit hooks из расширения
- Работаете в команде с настроенным pre-commit
